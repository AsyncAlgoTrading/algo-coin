...
EXCHANGE_MARKET_DATA_ENDPOINT = lambda name, typ: {
    ...
    (ExchangeType.GEMINI, TradingType.SANDBOX): 'wss://api.sandbox.gemini.com/v1/marketdata/BTCUSD',
    (ExchangeType.GEMINI, TradingType.LIVE): 'wss://api.gemini.com/v1/marketdata/BTCUSD',
